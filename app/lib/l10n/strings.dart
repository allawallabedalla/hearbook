...
class AppStrings {
  ...
  static const Map<String, String> values = {
    ...
    'settingsHealthDataOptInDescription': 'Mit deinem Schlafbeginn aus {source} findet Faden die Stelle schneller. Bleibt auf diesem Gerät.',
    ...
    'settingsNightWindowExplanation': 'In dieser Zeit achtet Faden darauf, ob du einschläfst.',
    ...
    'settingsAppearanceNightNote': 'Ist der Bildschirm sehr dunkel, zeigt Faden immer die gedimmte Nachtansicht.',
    ...
    'settingsAutoDownloadDescription': 'Im WLAN lädt Faden das offene und das nächste Buch.',
    ...
    'settingsCellularChaptersDescription': 'Ohne WLAN lädt Faden nur Kapitel für Kapitel, nie ganze Bücher.',
    ...
    'settingsSleepOnsetsExplanation': 'Ab 5 Nächten fragt Faden zuerst dort, wo du meist einschläfst. Zum Löschen nach links wischen. Bleibt auf diesem Gerät.',
    'settingsNightWindowSuggestion': 'Vorschlag: {time} übernehmen',
    'settingsHealthWrite': 'Einschlafzeit in Health eintragen',
    'settingsHealthWriteDescription': 'Trägt nach der Faden-Suche ein, wann du ungefähr eingeschlafen bist, wenn Health für die Nacht noch nichts hat. Bleibt auf dem iPhone.',
